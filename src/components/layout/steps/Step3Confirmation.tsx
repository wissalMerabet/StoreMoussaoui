...
const Step3Confirmation = ({ formData }: { formData: FormData }) => {
    ...
    <div className="md:max-w-6xl md:h-[480px] p-6 shadow-sm bg-white">
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-3 md:gap-6 text-sm">
        ...
        <div className="mt-7">
          ...
          <p className="font-medium text-sm px-2 py-1.5">Nom: {formData.Nom}</p>
          <p className="font-medium text-sm px-2 py-1.5">E-Mail: {formData.email}</p>
          <p className="font-medium text-sm px-2 py-1.5">Numéro: {formData.phone}</p>
          <p className="font-medium text-sm px-2 py-1.5">Wilaya: {formData.wilaya}</p>
        </div>

        <div className="mt-7">
          <h3 className="font-bold px-2 mb-4 text-xl">Conditions de réservation</h3>
